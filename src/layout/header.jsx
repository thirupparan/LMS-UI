        ...
        <React.Fragment>
          <li className='nav-item dropdown ml-auto'>
            ...
            <div aria-labelledby='userInfo' className='dropdown-menu'>
              ...
              <Link to='/configurecalendar' className='dropdown-item'>
                Settings
              </Link>
              <a href='#' className='dropdown-item'>
                Activity log{" "}
              ...
              <form id='searchForm' className='ml-auto d-none d-lg-block'>
                <div className='form-group position-relative mb-0'>
                  <button
                    ...
                    className='position-absolute bg-white border-0 p-0'
                  >
                    <i className='o-search-magnify-1 text-gray text-lg'></i>
                  </button>
                  <input
                    type='search'
                    placeholder='Search ...'
                    className='form-control form-control-sm border-0 no-shadow pl-4'
                  />
                </div>
              </form>
            </li>
